...
export class InfoPagePage implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private router: Router, private kokapenaService: KokapenaService, public smartAudio: SmartAudioService) {
    this.route.queryParams.subscribe(params => {
      if (params && params.idKokapen) {
        ...
        smartAudio.preload('audio-' + this.idKokapen, 'assets/audio/kokapen-' + this.idKokapen + '.mp3')
      }
    });
  }

  ngOnInit() {
    this.smartAudio.play('audio-' + this.idKokapen);
  }

  ngOnDestroy() {
    this.smartAudio.pause();
  }
